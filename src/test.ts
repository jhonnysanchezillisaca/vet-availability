...
Deno.test("getAvailableTimesFromRawText should be sorted by time", () => {
  const input = `
      [
          {
            "scheduleId": 4711,
...
Deno.test("getAvailableTimesFromRawText should not return intervals in break when overlapping breaks", () => {
  const input = `
      [
          {
            "scheduleId": 4711,
